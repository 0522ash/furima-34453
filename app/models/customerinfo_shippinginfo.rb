class CustomerinfoShippinginfo
  ...
  def save
    ...
    Shippinginfo.create(postal_code: postal_code, ship_from_id: ship_from_id, city: city, address: address,
                        building_name: building_name, phone_number: phone_number, customerinfo_id: customerinfo.id)
  end
end
